package com.tomaja.android.tricopter_lights;
...
public class DeviceControlActivity extends Activity {
    ...
    private BluetoothGattCharacteristic mRGBCharacteristic;
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                byte[] currentColor = intent.getStringExtra(BluetoothLeService.EXTRA_DATA).getBytes();
                int i = 0;
                //byte[] currentColor; // = intent.getByteArrayExtra(BluetoothLeService.EXTRA_DATA);
                if(currentColor != null)
                {
                    sbRed.setProgress(currentColor[0]);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        sbRed = (SeekBar) findViewById(R.id.seekBar);
        sbGreen = (SeekBar) findViewById(R.id.seekBar2);
        sbBlue = (SeekBar) findViewById(R.id.seekBar3);
        sbWhite = (SeekBar) findViewById(R.id.seekBar4);
        ...
        sbRed.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress,boolean fromUser) {
                // TODO Auto-generated method stub
                byte[] value = mRGBCharacteristic.getValue();
                if(value == null) {
                    value = new byte[4];
                }
        ...
        sbWhite.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        for (BluetoothGattService gattService : gattServices) {
            ...
            Log.w("TOMAJA", uuid);
            if(uuid.equals("0000ffb0-0000-1000-8000-00805f9b34fb")) {
                Log.w("TOMAJA", "RGB LED Service Present");

                List<BluetoothGattCharacteristic> gattCharacteristics =
                        gattService.getCharacteristics();
                for (BluetoothGattCharacteristic characteristic : gattCharacteristics) {
                    if (characteristic.getUuid().toString().equals("0000ffb5-0000-1000-8000-00805f9b34fb")) {
                        mRGBCharacteristic = characteristic;
                        Log.w("TOMAJA", "Combined RGB LED Caharacteristic Present");

                        mBluetoothLeService.mBluetoothGatt.readCharacteristic(mRGBCharacteristic);
                    }
                }
            }
        }
